...
"""
FastAPI application for the Micro Soc Gym Environment.

This module creates an HTTP server that exposes the MicroSocGymEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m micro_soc_gym.server.app
    ...
    multiple workers:
        uvicorn micro_soc_gym.server.app:app --workers 4
    """
    import uvicorn
